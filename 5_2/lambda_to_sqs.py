...
def lambda_handler(event, context):
  ...
  [
    "IDEAS",
    "ideas-skyalp-finansal-teknolojiler/"
  ],
  [
    "IDGYO",
    "idgyo-idealist-gmyo/"
  ...
  [
    ...
    queue_url = 'https://sqs.eu-north-1.amazonaws.com/339712851937/step1'

    # Send each item in the array as a separate message to the SQS queue
    for item in data:
        sqs.send_message(QueueUrl=queue_url, MessageBody=json.dumps(item))

    return {
        'statusCode': 200,
        'body': 'Messages sent to SQS queue'
    }